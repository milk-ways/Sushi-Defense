...
public class Enemy : MonoBehaviour
{
    ...
    private IEnumerator OnMove()
    {
        ...
        while (true)
        {
            ...
            // 적의 현재위치와 목표위치의 거리가 0.02 * movemet2D.MoveSpeed 보다 작을 때 if 조건문 실행
            // movement2D 저거 곱해주는 이유는 속도가 빠르면 한 프레임에 0.02보다 크게 움직이기 때문에if 조건문에 걸리지 않고 경로를 탈주하는 오브젝트가 발생 가능
